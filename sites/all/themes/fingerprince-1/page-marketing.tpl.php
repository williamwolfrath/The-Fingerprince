...
<body class="<?php print $body_classes; ?> marketing-body">

  <span id="toprightimg"></span>
      ...
      <?php if ($search_box or $primary_links or $secondary_links or $navbar): ?>
        <div id="navbar"><div id="navbar-inner" class="region region-navbar">
          ...
          <?php if ($primary_links): ?>
            <div id="primary">
              <?php print theme('links', $primary_links); ?><div id="popclose">close</div>
            </div> <!-- /#primary -->
          <?php endif; ?>
